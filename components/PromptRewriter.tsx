    ...
    <div className="max-w-6xl mx-auto animate-fade-in space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
            ...
            <textarea
              ...
              className="w-full h-40 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none p-4 text-sm resize-none transition-all placeholder:text-slate-400"
            />
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
            ...
            <h2 className="text-xs font-black text-slate-500 uppercase tracking-widest mb-6 flex items-center gap-2">
              <RefreshCw className={`w-4 h-4 text-indigo-500 ${isProcessing ? 'animate-spin' : ''}`} />
              2. Transformations
            </h2>
            ...
            <div className="space-y-6">
                      ...
                      <button
                        ...
                        className={`flex flex-col items-center justify-center p-3 border rounded-xl text-[10px] font-bold transition-all disabled:opacity-50 ${
                          isSelected
                            ...
                            : 'bg-slate-50 dark:bg-slate-900/50 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300'
                        }`}
                      >
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-slate-700">
                ...
                <button
                  ...
                  className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-200 dark:disabled:bg-slate-800 disabled:text-slate-400 text-white rounded-xl font-black shadow-lg shadow-indigo-500/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2 text-xs uppercase tracking-widest"
                >
                  {isProcessing ? (
        ...
        <div className="flex flex-col h-full">
          <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col h-full">
            <div className="flex justify-between items-center mb-6">
              ...
              {revisedPrompt && (
                <div className="flex gap-2">
                  <button
                    onClick={useAsSource}
                    className="flex items-center gap-1.5 text-xs font-bold px-4 py-2 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-xl hover:bg-indigo-600 hover:text-white transition-all"
