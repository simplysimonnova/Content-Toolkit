                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-1 gap-4">
                                <div
                                    ...
                                    className={`h-32 border-2 border-dashed rounded-xl flex flex-col items-center justify-center cursor-pointer transition-all ${inputFile ? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-900/20' : 'border-slate-200 dark:border-slate-700 hover:border-indigo-300'
                                        }`}
                                >
