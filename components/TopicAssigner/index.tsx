          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh] transition-colors">
            ...
            <div className="p-6 overflow-y-auto space-y-8 bg-white dark:bg-slate-800">
              ...
              <div>
                ...
                <div
                  className={`border-2 border-dashed rounded-lg p-6 text-center transition-colors cursor-pointer ${topicFile ? 'border-indigo-300 dark:border-indigo-500/50 bg-indigo-50/50 dark:bg-indigo-500/10' : 'border-slate-300 dark:border-slate-600 hover:border-indigo-300 dark:hover:border-indigo-400 hover:bg-slate-50 dark:hover:bg-slate-700'
                    }`}
                ...
                >
                  ...
                  {topicFile ? (
                    <div className="flex flex-col items-center">
                      <Database className="w-8 h-8 text-indigo-600 dark:text-indigo-400 mb-2" />
              ...
              {topicHeaders.length > 0 && (
                <div className="space-y-6 border-t border-slate-200 dark:border-slate-700 pt-6">
                  ...
                  <div>
                    ...
                    <select
                      className="w-full border-slate-300 dark:border-slate-600 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-white dark:bg-slate-700 text-slate-900 dark:text-white"
            ...
            <div className="p-4 border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 flex justify-end">
              <button
                ...
                className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-sm font-medium active:scale-95"
              >
                Save & Close
              </button>
            </div>
